 ...
 * ******************************************************************************
 */
static void can_device_ops_update_status(void *p_self, can_device_status_t status)
{
    can_device_t *p_dev = (can_device_t *)p_self;
    if (status <= CAN_STATUS_UNKNOWN && status >= CAN_STATUS_IDLE)
    {
 ...
 * ******************************************************************************
 */
static can_device_status_t can_device_ops_return_status(void *p_self)
{
    can_device_t *p_dev = (can_device_t *)p_self;
 ...
 * ******************************************************************************
 */
static void can_device_ops_reinit(void *p_self)
{
    can_device_t *p_dev = (can_device_t *)p_self;
